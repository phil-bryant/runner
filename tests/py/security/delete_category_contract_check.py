...
def main() -> int:
    ...
    schema_path, base_url, output_json_path, write_token, write_token_header_name, dast_run_id = sys.argv[1:7]
    ...
    preflight_status, preflight_payload = request_json(
        "GET", f"{base_url}/v1/categories", write_token, write_token_header_name, None
    )
    ...
    create_status, create_payload = request_json(
        "POST", f"{base_url}/v1/categories", write_token, write_token_header_name, seed_payload
    )
    ...
    delete_status, delete_payload = request_json(
        "DELETE", f"{base_url}/v1/categories/{category_id}", write_token, write_token_header_name, None
    )
